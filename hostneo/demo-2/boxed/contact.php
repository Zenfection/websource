                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown"><a href="index.html" class="dropdown-toggle">Home <i class="fa fa-angle-down"></i></a>
                    <ul role="menu" class="dropdown-menu">
                      ...
                      <li><a href="index.html"><i class="fa fa-angle-right"></i> Home Demo 2</a></li>
  ...
  <footer class="footer-bg m-top8">
    <div class="container">
      ...
      <div class="col-md-6 nopadding m-bottom4">
        ...
        <form action="index.html" id="newsletter" method="get">
          <input type="text" onblur="if (this.value == '') {this.value = 'Enter your Domain Name here...';}" onfocus="if (this.value == 'Enter your Domain Name here...') {this.value = '';}" value="Enter your Name here..." id="newslette" name="dsearch" class="input-text newsfield">
          <input type="submit" class="btn green-button uppercase" value="submit" id="submit">
        </form>
      </div>
      <div class="col-md-6 nopadding m-bottom4">
        <h5 class="font-white m-bottom1 font-uppercase font16">Find Us on</h5>
        <img alt="" src="images/site-img45.jpg"> <img alt="" src="images/site-img46.jpg"> </div>
    </div>
